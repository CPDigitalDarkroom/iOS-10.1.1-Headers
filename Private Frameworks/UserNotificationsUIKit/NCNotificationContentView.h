...
@property (assign,nonatomic) long long thumbnailViewContentMode;                                                                                                //@synthesize thumbnailViewContentMode=_thumbnailViewContentMode - In the implementation block
@property (nonatomic,retain) UIView * accessoryView;                                                                                                            //@synthesize accessoryView=_accessoryView - In the implementation block
@property (assign,nonatomic) BOOL showAdditionalMessageLines;                                                                                                   //@synthesize showAdditionalMessageLines=_showAdditionalMessageLines - In the implementation block
