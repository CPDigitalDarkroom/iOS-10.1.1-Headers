...
#import "SBLockScreenMesaCoordinatorDelegate-Protocol.h"
...
@protocol SBAlertingNotificationDestination, SBFLockOutStatusProvider, SBHomeButtonShowPasscodeRecognizer;
