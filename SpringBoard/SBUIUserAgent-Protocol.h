...
@class NSDictionary, NSString, NSURL, SBAlertItem, SBAwayViewPluginController, SBUIFullscreenAlertController, UIView;
@protocol SBBulletinAlertHandlerRegistry, SBUIActiveOrientationObserver, SBUIProgressiveBlur;
