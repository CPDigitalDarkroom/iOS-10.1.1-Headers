...
@class CloudTabItemView, CloudTabTable, GradientView, HighlightRecognizer, NSArray, NSMutableSet, NSString, NSTimer, ReorderingAutoscroller, TabExplanationView, TiltedTabItem, UIImage, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPreviewForceInteractionProgress, UIScrollView, UITapGestureRecognizer, ViewReuseManager, WBSCloudTab;
