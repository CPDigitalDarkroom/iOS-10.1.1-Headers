...
@class FrequentlyVisitedSitesSectionHeaderView, GrabbedFavorite, NSArray, NSMutableArray, NSString, ReorderingAutoscroller, UICollectionView, UICollectionViewFlowLayout, UILongPressGestureRecognizer, UITapGestureRecognizer, _UIFeedbackImpactBehavior;
