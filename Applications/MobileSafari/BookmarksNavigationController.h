...
@class NSArray, NSMutableDictionary, NSString, NSTimer, SidebarInteractionReporter, SocialLinksViewController, UIBarButtonItem, UIImageView, UISegmentedControl, UIView, WebBookmarkCollection, _UIBackdropView, _UINavigationControllerPalette;
...
- (_Bool)_shouldShowCollectionSegmentedControl;
- (void)_hidePalette;
- (void)_showPalette;
